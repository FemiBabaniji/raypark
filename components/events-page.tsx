      ...
      <div className="relative z-10">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20">
          <main className="w-full relative mt-6">
            <div
              className={`flex items-start gap-6 md:gap-8 transition-all duration-500 ease-in-out ${showRightColumn ? "justify-start" : "justify-center"}`}
            >
              <div
                className={`flex-1 min-w-0 transition-all duration-500 ease-in-out ${
                  showRightColumn
                    ? "max-w-[600px] md:max-w-[800px] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1200px] mr-0"
                    : "max-w-[800px] md:max-w-[1000px] lg:max-w-[1200px] xl:max-w-[1400px] mx-auto"
                }`}
              >
                <EventsLeftColumn
