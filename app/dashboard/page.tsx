...
import { Plus, MoreVertical, Grid3x3, List, Bell, User } from 'lucide-react'
      ...
      <div className="relative z-10">
        ...
        <main className="pt-20 pb-16 px-8">
          <div className="max-w-3xl mx-auto">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative z-50">
                  ...
                  {isUserDropdownOpen && (
                    <>
                      <div className="fixed inset-0 z-40" onClick={() => setIsUserDropdownOpen(false)} />
                      <div className="absolute right-0 top-full mt-2 w-40 bg-neutral-900/95 backdrop-blur-xl rounded-lg shadow-lg border border-white/10 overflow-hidden z-50">
                        <Link
                          href="/dashboard"
                          className="block px-3 py-2 text-white hover:bg-white/5 transition-colors text-sm"
                          onClick={() => setIsUserDropdownOpen(false)}
                        >
                          Dashboard
                        </Link>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white/10 hover:bg-white/15 backdrop-blur-sm rounded-lg text-white text-sm font-medium transition-colors border border-white/10"
                >
            ...
            <div className="mb-16">
              <h2 className="text-xl font-semibold text-white mb-6">My Portfolios</h2>
