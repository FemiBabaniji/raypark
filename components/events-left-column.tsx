...
export default function EventsLeftColumn({
  ...
  return (
    <div className="w-full flex justify-center">
      {!showRightColumn && onToggleRightColumn && (
        <button
          onClick={onToggleRightColumn}
          className="fixed right-6 top-24 z-50 w-12 h-12 rounded-xl bg-white/10 hover:bg-white/15 backdrop-blur-xl border border-white/20 transition-all duration-500 ease-in-out flex items-center justify-center shadow-xl animate-in fade-in slide-in-from-right-4"
      ...
      <div className="w-full max-w-[1200px] transition-all duration-500 ease-in-out">
          ...
          <>
            <div className="mt-6 flex flex-col xl:flex-row gap-6 w-full">
              <div className="w-full xl:w-[70%] xl:flex-shrink-0">
                <div className={`${CONTAINER_STYLES} h-[600px] flex flex-col overflow-hidden`}>
        ...
        {activeTab === "Events" && (
          <>
            <div className={`mt-6 ${CONTAINER_STYLES} h-[600px] flex flex-col overflow-hidden`}>
              <div className="mb-8 flex items-start justify-between flex-shrink-0">
                <div>
        ...
        {activeTab === "Meetings" && (
          <div className={`mt-6 ${CONTAINER_STYLES} h-[600px] flex flex-col`}>
            <MeetingsWidget onMeetingClick={(id) => console.log("Meeting clicked:", id)} />
          </div>
        )}
