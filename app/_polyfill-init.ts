...
// This file runs immediately when imported to apply polyfills before any other code
if (typeof window !== "undefined") {
  ...
  // Wrap Map.prototype methods to add toArray to returned iterators
  ...
  // Wrap Set.prototype methods to add toArray to returned iterators
  ...
  console.log("[v0] ✅ Polyfills applied successfully")
}
