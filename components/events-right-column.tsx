      ...
      {onToggleRightColumn && (
        <div className="mb-6 flex justify-start">
          <button
            ...
            className="w-12 h-12 rounded-full bg-white/10 hover:bg-white/15 transition-all duration-200 flex items-center justify-center border border-white/10 hover:border-white/20 shadow-lg"
