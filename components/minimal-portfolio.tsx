  ...
  return (
    <div className="min-h-screen bg-zinc-950 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <Card className="bg-zinc-900/50 border-zinc-800 p-6 text-center rounded-3xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="bg-zinc-900/50 border-zinc-800 rounded-3xl h-80"></Card>
          ...
          <div className="space-y-4">
            <Card className="bg-zinc-900/50 border-zinc-800 h-24 rounded-3xl"></Card>
            <Card className="bg-zinc-900/50 border-zinc-800 h-20 rounded-3xl"></Card>

            {/* Education Section */}
            <Card className="bg-zinc-900/50 border-zinc-800 p-4 rounded-3xl">
