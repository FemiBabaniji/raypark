      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl w-full">
          <div
            ...
            className="group relative overflow-hidden rounded-2xl cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl bg-gradient-to-br from-neutral-900/50 to-neutral-800/50 backdrop-blur-xl border border-neutral-700/50"
          >
            ...
            <div className="relative p-8 text-center">
              <div className="border border-neutral-600/50 rounded-lg w-32 h-20 flex items-center justify-center mx-auto mb-4 p-3 group-hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-neutral-900/50 to-neutral-800/50">
